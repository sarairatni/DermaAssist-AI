from sqlalchemy import Column, String, Float, DateTime, Enum, ForeignKey, func
...
class SkinImage(Base):
    ...
    minio_url = Column(String(500), nullable=False)  # URL de stockage MinIO
    source = Column(Enum(ImageSource), default=ImageSource.DOCTOR)
